<!--    Name:       	Ryan Bolesta
        ...
        Filename:   	cartSession.php
        Purpose:    	Contains the shopping cart class with methods to 
						retrieve and add items as well as a print function-->

<?php 
// original file: lab-12-3-shoppingcart-session.php 
// Based on Creating a Shopping Cart Class Using Object-Oriented Programming in PHP by Larry Ullman 
...
class ShoppingCart { 
    ...
    { 
        ...
        { 
            ...
            foreach ($this->items as $arr) { 
                $item = $arr['item']; // Get the item object 
                echo '<tr><td width="400px">' . $item->getName() . '</td>'; 
                ...
                echo '<td width="200px" align="center"><form>'; 
            ...
            echo '<td class="last-row">&nbsp;</td></tr>'; 
			echo '<tr><td colspan="4"><button id="checkoutBtn" name="checkout" onclick="window.location.href=\'customer.html\'">Checkout</button></td></tr></table>'; 
        } 
